...
const CustomerDetails = () => {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      {/* Main Content - 2-column layout on tablet */}
      <div className="flex-1 overflow-hidden">
        <div className="h-full tablet:grid tablet:grid-cols-[38%_62%] tablet:gap-0">
          {/* Left Section: Customer Details - Tablet Only */}
          <div className="hidden tablet:block tablet:overflow-y-auto tablet:border-r tablet:border-gray-200 tablet:bg-gray-50">
          ...
          {/* Right Section: Orders & Service Pictures */}
          <div className="flex-1 overflow-y-auto px-4 tablet:px-5 pt-12 tablet:pt-4 pb-6 space-y-4 tablet:space-y-3">
            {/* Orders & Service Pictures */}
            <Card className="rounded-xl border border-gray-100 shadow-sm overflow-hidden tablet:max-w-5xl">
