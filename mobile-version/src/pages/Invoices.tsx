    ...
    switch (action) {
      ...
      case "refund":
        ...
        setRefundInvoice({
          ...
          payment_method: (invoice as any).payment_method || (invoice as any).payment?.payment_method,
          payment: (invoice as any).payment,
          payment_method_details: (invoice as any).payment_method_details || (invoice as any).payment?.payment_method_details || (invoice as any).payment?.method_details,
          paymentMethodDetails: (invoice as any).paymentMethodDetails,
          cardBrand: (invoice as any).cardBrand,
          cardLast4: (invoice as any).cardLast4 || (invoice as any).payment?.payment_method_details?.card?.last4 || (invoice as any).payment?.method_details?.card?.last4,
